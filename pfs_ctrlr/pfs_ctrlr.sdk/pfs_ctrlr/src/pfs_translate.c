...
static void load_enables_dirs(QUEUE(motor_cmd) *q, uint8_t brd, uint8_t sect) {
    ...
    enq_wr_cmd(q, PFS_CTRL_MTR_DIR1, (dirs[sect][brd] >> 16) & 0xFfff);
    enq_wr_cmd(q, PFS_CTRL_MTR_DIR2, (dirs[sect][brd] >> 32) & 0xFfff);
    enq_wr_cmd(q, PFS_CTRL_MTR_DIR3, (dirs[sect][brd] >> 48) & 0xFfff);
