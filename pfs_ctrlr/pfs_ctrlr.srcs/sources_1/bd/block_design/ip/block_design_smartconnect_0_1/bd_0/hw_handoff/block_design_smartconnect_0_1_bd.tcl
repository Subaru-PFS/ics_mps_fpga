...
################################################################
# This is a generated script based on design: bd_ed65
#
...
CONFIG.USER_BITS_PER_BYTE {0} \
  ...
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins i_ar_node/m_sc_aclk] [get_bd_pins i_ar_node/s_sc_aclk] [get_bd_pins i_aw_node/m_sc_aclk] [get_bd_pins i_aw_node/s_sc_aclk] [get_bd_pins i_b_node/m_sc_aclk] [get_bd_pins i_b_node/s_sc_aclk] [get_bd_pins i_r_node/m_sc_aclk] [get_bd_pins i_r_node/s_sc_aclk] [get_bd_pins i_w_node/m_sc_aclk] [get_bd_pins i_w_node/s_sc_aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins i_ar_node/m_sc_aresetn] [get_bd_pins i_ar_node/s_sc_aresetn] [get_bd_pins i_aw_node/m_sc_aresetn] [get_bd_pins i_aw_node/s_sc_aresetn] [get_bd_pins i_b_node/m_sc_aresetn] [get_bd_pins i_b_node/s_sc_aresetn] [get_bd_pins i_r_node/m_sc_aresetn] [get_bd_pins i_r_node/s_sc_aresetn] [get_bd_pins i_w_node/m_sc_aresetn] [get_bd_pins i_w_node/s_sc_aresetn]
...
CONFIG.PAYLD_WIDTH {60} \
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins ar_la_in_swbd/aclk] [get_bd_pins ar_la_out_swbd/aclk] [get_bd_pins aw_la_in_swbd/aclk] [get_bd_pins aw_la_out_swbd/aclk] [get_bd_pins b_la_in_swbd/aclk] [get_bd_pins b_la_out_swbd/aclk] [get_bd_pins i_nodes/aclk] [get_bd_pins r_la_in_swbd/aclk] [get_bd_pins r_la_out_swbd/aclk] [get_bd_pins w_la_in_swbd/aclk] [get_bd_pins w_la_out_swbd/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins i_nodes/aresetn]
...
CONFIG.SEG006_BASE_ADDR {0x0000000044A10000} \
