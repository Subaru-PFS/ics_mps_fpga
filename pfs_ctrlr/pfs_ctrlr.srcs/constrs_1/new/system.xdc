...
## This implements the swappping of sectors so that they line up in an orderly way
## Look at the Daughtercard with chips facing you it has the following sector order:
## Left->Right:     5, 3, 1, 4, 2, 0
## This remaps the sectors so that when looking at it they are now
## Left->Right:     5, 4, 3, 2, 1, 0
